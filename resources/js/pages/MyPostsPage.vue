                ...
                <div class="card text-center">
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs">
                            <li class="nav-item">
                                <router-link exact :to="{name: 'my-posts'}" class="nav-link active" href="#">All</router-link>
                            </li>
                            <li class="nav-item">
                                <router-link exact :to="{name: 'my-posts', query: {type: 'questions'}}" class="nav-link active" href="#">Questions</router-link>
                            </li>
                            <li class="nav-item">
                                <router-link exact :to="{name: 'my-posts', query: {type: 'answers'}}" class="nav-link active" href="#">Answers</router-link>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
...
export default {
    ...
    methods: {
        fetchPosts() {
            axios.get('/my-posts', {params: this.$route.query}).then(({data}) => {
